...
const AuthPages: React.FC<AuthPagesProps> = ({ onLogin, onBack, isAdmin = false }) => {  const { isDarkMode } = useTheme();
        ...
        <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 rounded-3xl border border-white/20 dark:border-gray-700 shadow-xl dark:shadow-none p-8">
          ...
          {onBack && (
            <div className="mt-6 text-center">
              <button onClick={onBack} className="text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 text-sm">
