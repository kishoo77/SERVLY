...
import { Users, Calendar, DollarSign, TrendingUp, Plus, Search, Filter, Eye, CreditCard as Edit, Trash2, Clock, Award, FileText, Settings, Download, ArrowLeft, Star, Minus } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50">
      ...
      {showAddEmployee && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="backdrop-blur-xl bg-white/95 rounded-3xl border border-white/20 shadow-xl p-8 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
