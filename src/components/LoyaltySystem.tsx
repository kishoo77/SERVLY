...
import { shareToAppleWallet, WalletPassData } from '../utils/appleWallet';
                    ...
                    <div key={customer.id} className="backdrop-blur-xl bg-white/60 rounded-3xl border border-white/20 shadow-lg p-6">
                      ...
                      <div className="space-y-3">
                          ...
                          <button
                            onClick={() => {
                              const walletData: WalletPassData = {
                                ...
                                cardColor: customer.cardColor,
                                textColor: customer.textColor
                              };
                              shareToAppleWallet(walletData);
                            }}
                            className="w-full mt-3 py-2 bg-white text-black rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors"
                          >
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          ...
                          <button
                            onClick={() => {
                              alert(`تفاصيل العميل:\n\nالاسم: ${customer.name}\nالبريد: ${customer.email}\nالهاتف: ${customer.phone}\nالنقاط: ${customer.points}\nالمستوى: ${getLevelName(customer.level)}\nتاريخ الانضمام: ${new Date(customer.joinDate).toLocaleDateString('ar-EG')}\nإجمالي المشتريات: ${customer.totalSpent} ر.س`);
                            }}
                            className="px-3 py-2 bg-blue-100 text-blue-800 rounded-xl hover:bg-blue-200 transition-colors text-sm"
                            title="عرض التفاصيل"
                          >
                          ...
                          <button
                            ...
                            className="px-3 py-2 bg-red-100 text-red-800 rounded-xl hover:bg-red-200 transition-colors text-sm"
                            title="حذف العميل"
                          >
