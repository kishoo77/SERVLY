...
import { ArrowLeft, Phone, Mail, MapPin, Clock, MessageCircle, Send, CheckCircle, Globe, Facebook, Twitter, Instagram, Linkedin, Youtube } from 'lucide-react';
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 space-x-reverse">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">+20 100 123 4567</p>
                    <p className="text-gray-600 dark:text-gray-300">+20 100 123 4568</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 space-x-reverse">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">info@servly.com</p>
                    <p className="text-gray-600 dark:text-gray-300">support@servly.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 space-x-reverse">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">شارع التحرير، وسط البلد</p>
                  </div>
                </div>
